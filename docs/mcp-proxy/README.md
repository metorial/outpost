...
- [Outpost registration](../registration.md): the challenge and response handshake, `OutpostAuth`,
  and credential stores.
- [Instances and adapters](../instances-and-adapters.md): starting an `OutpostInstance` directly
  and writing your own adapter.
- [Logging](../logging.md): the full logger reference. This tutorial's
